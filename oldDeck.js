var playtest = {"name":"420 Hazyyyyy","author":"DBGxOsO","created":"2018-01-18","skill":"Beatdown!","main":

[{"name":"Hazy Flame Cerbereus","amount":1},
{"name":"Hazy Flame Cerbereus","amount":1},
{"name":"Hazy Flame Cerbereus","amount":1},
{"name":"Hazy Flame Sphynx","amount":1},
{"name":"Hazy Flame Sphynx","amount":1},
{"name":"Hazy Flame Sphynx","amount":1},
{"name":"Chow Len the Prophet","amount":1},
{"name":"Earth Armor Ninja","amount":1},
{"name":"Earth Armor Ninja","amount":1},
{"name":"Earth Armor Ninja","amount":1},
{"name":"Hazy Flame Peryton","amount":1},
{"name":"Hazy Flame Peryton","amount":1},
{"name":"Hazy Flame Peryton","amount":1},
{"name":"Sphere Kuriboh","amount":1},
{"name":"Anti-Magic Arrows","amount":1},
{"name":"Anti-Magic Arrows","amount":1},
{"name":"Anti-Magic Arrows","amount":1},
{"name":"Blue-Eyes White Dragon","amount":1,"test":"123"},
{"name":"Mausoleum of the Emperor","amount":1},
{"name":"Mausoleum of the Emperor","amount":1}],
"extra":[],
...
$('#play').click(function () {
  ...
  function dealHand(i) {
    ...
    addHand(decklist[i].name, decklist[i].id, decklist[i].test);
  ...
  function addCardToHandDiv(i, extra) {
    if (extra == 0)
    $('#hand').append(`<div id="cardId${decklist[i].id}" class="testcard-slot-row"><div class="hand cardMain${decklist[i].id}"><img id="${decklist[i].id}" src="https://yugiohprices.com/api/card_image/${decklist[i].name}" /><p>${decklist[i].test}</p></div>`);else
    if (extra == 1)
