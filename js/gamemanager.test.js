...
let GameManager = {
  ...
  setFight: function() {
    ...
    getHeader.innerHTML = '<p>Task: Click on your Monster to Choose a move!</p>';
/*     getActions.innerHTML = '<a href="#" class="btn-prefight" onclick="PlayerMoves.calcAttack()">Attack!</a>'; */
  ...
  setPlayer: function(thisCard){
    ...
    $(".footer-attack a:first").remove();}
        ...
        player.name = (thisCard.childNodes[0].alt);
        console.log(player.name);
        player.health = (thisCard.childNodes[1].children[1].childNodes[0].data).replace(/\D/g,'');
        player.mana = (thisCard.childNodes[1].children[2].childNodes[0].data).replace(/\D/g,'');
        player.strength = (thisCard.childNodes[1].children[3].childNodes[0].data).replace(/\D/g,'');
        player.agility = (thisCard.childNodes[1].children[4].childNodes[0].data).replace(/\D/g,'');
        player.speed = (thisCard.childNodes[1].children[5].childNodes[0].data).replace(/\D/g,'');
        player.defense = (thisCard.childNodes[1].children[6].childNodes[0].data).replace(/\D/g,'');
        player.attPerTurn = (thisCard.childNodes[1].children[7].childNodes[0].data).replace(/\D/g,'');
